...
from pages.page6 import page6_layout
    ...
    [
        ...
        html.Div(
            [
                html.P(
                    """
                    This dashboard is part of a thesis exploring innovative approaches to assessing 
                    the quality of dimensionality reduction techniques. By introducing a path-based paradigm, 
                    it aims to overcome limitations of traditional neighborhood-based metrics, capturing 
                    richer structural details and offering a more nuanced perspective on data visualization.
                    The tools and analyses presented here serve as a foundation for further research, 
                    emphasizing both computational efficiency and intuitive representation.
                    """,
                    style={
                        "text-align": "center",
                        "font-size": "1.2rem",
                ...
                html.P(
                    """
                    The image below illustrates the algorithmic workflow employed in this thesis. 
                    Starting from a low dimensional representation of high-dimensional data, a graph is constructed 
                    to preserve data point relationships. These relationships are then analyzed by comparing 
                    paths in both the low-dimensional (LD) and high-dimensional (HD) spaces using graph-edit distance. 
                    This innovative approach ensures that the quality of dimensionality reduction techniques is 
                    quantitatively assessed by measuring how well the original data structures are retained.
                    """,
                    style={
                        "text-align": "center",
                        "font-size": "1.2rem",
