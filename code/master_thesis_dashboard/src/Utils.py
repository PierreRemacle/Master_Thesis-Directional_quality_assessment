...
def enveloppe_of_cluster(LD_data):
    ...
    concave_hull, edge_points, edges = alpha_shape(LD_data_rescale, alpha=0.3)
...
# grah = delaunay_graph(LD_data)
# start = time.time()
# print(dijkstra(grah, 0))
# end = time.time()
# print(end-start)
# start = time.time()
# print(dijkstra_slow(grah, 0))
# end = time.time()
# print(end-start)
# start = time.time()
# print(dijkstrafib(grah, 0))
# end = time.time()
# print(end-start)
